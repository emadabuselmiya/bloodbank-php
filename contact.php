...
<head>
    ...
    <title>BloodBank | Contact As</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-12">
                ...
                <form name="sentMessage" method="post">
                    ...
                    <button type="submit" name="send" class="btn btn-danger" style="cursor:pointer;width:30%;margin-top: 25px;margin-bottom: 25px;">Send Message</button>
                </form>
            </div>
            ...
            <?php
            $pagetype = $_GET['type'];
            $sql = "SELECT address, email, phone from contactusinfo";
            $query = $conn->prepare($sql);
            ...
            if ($query->rowCount() > 0) {
                foreach ($results as $result) { ?>
                    <div class="col-lg-12 mb-12" style="display: none;">
                        ...
                        <p>
                            <abbr title="Email">E</abbr>: <?= $result->email ?>
                            </a>
                        </p>
                <?php }
            } ?>
